...
const Introduction = () => {
  ...
  return (
    <Section className="app__introduction z-0">
      ...
      <IntroductionChair />
      <Header />
      <h1 className="mt-auto pb-4 max-w-[850px] z-10">
        <span>SHIJO</span> <span>EKSPERIENCEN</span> <span>E RE</span> <span>TE GAMEINGUT</span>
      </h1>
      <p className="text md:pb-24 text-gray-400 lg:max-w-[585px] md:max-w-[380px] max-w-full font-small z-10">
