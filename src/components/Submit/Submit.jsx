...
export const Submit = (props) => {
  ...
  const loader = (
    <div role="status" className="relative w-full aspect-w-1 aspect-h-1">
      <svg
        aria-hidden="true"
        className="absolute inset-0 w-full h-full animate-spin fill-current"
        viewBox="0 0 100 101"
        fill="none"
      ...
      <span className="opacity-0 w-1 overflow-hidden">...</span>
    </div>
  );
  ...
  return (
    <div className={`flex flex-col w-100 ${className || "mt-4"}`}>
      {linkTitle && (
